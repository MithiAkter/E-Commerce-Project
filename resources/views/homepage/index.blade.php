...
<meta name="description" content="E-Commerce shop project">
...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ asset('frontend/images/mail.png') }}" alt=""></div><a  href="{{ url('https://colorlib.com/cdn-cgi/l/email-protection#234542505750424f465063444e424a4f0d404c4e') }}"><span class="__cf_email__" data-cfemail="34525547404755585147745359555d581a575b59">[email&#160;protected]</span></a></div>
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<div class="menu_contact">
								...
								<div class="menu_contact_item"><div class="menu_contact_icon"><img src="frontend/images/mail_white.png" alt=""></div><a href="{{ url('https://colorlib.com/cdn-cgi/l/email-protection#fd9b9c8e898e9c91988ebd9a909c9491d39e9290') }}"><span class="__cf_email__" data-cfemail="5f393e2c2b2c3e333a2c1f38323e3633713c3032">[email&#160;protected]</span></a></div>
							</div>
						</div>
					</div>
				</div>
	...
	<!-- Banner -->
	@php
		$slider=DB::table('products')->join('brands','products.brand_id','brands.id' )->select('products.*','brands.brand_name')
								...
								<div class="product_panel panel">
									<div class="arrivals_slider slider">
										...
										<div class="arrivals_slider_item">
											<div class="border_active"></div>
											<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
												<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="frontend//new_6.jpg" alt=""></div>
												<div class="product_content">
													<div class="product_price">$379</div>
													<div class="product_name"><div><a href="product.html">Huawei MediaPad...</a></div></div>
													<div class="product_extras">
					...
					<div class="tabbed_container">
						...
						<div class="bestsellers_panel panel active">
							...
							<div class="bestsellers_slider slider">
								...
								<div class="bestsellers_item">
									<div class="bestsellers_item_container d-flex flex-row align-items-center justify-content-start">
										<div class="bestsellers_image"><img src="frontend//best_6.png" alt=""></div>
										<div class="bestsellers_content">
											<div class="bestsellers_category"><a href="#">Headphones</a></div>
